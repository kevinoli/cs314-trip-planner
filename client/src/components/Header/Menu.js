...
import { FaPlus, FaTrashAlt, FaFolderOpen, FaSave, FaSearch } from 'react-icons/fa';
...
function buildMenuButtons(props) {
	return [
		...
		new MenuButtonProps('find-place-button', props.toggleFindPlace, <FaSearch />, 'Find Place'), 
		new MenuButtonProps('save-trip-button', props.toggleSaveFile, <FaSave />, 'Save Trip'),
